...
const statusColor = (status: string) => {
  const map: Record<string, string> = {
    ...
    delivered: "bg-teal-500/20 text-teal-700",
    completed: "bg-green-600/20 text-green-800",
    cancelled: "bg-red-500/20 text-red-700",
    unpaid: "bg-orange-500/20 text-orange-700",
    refunded: "bg-purple-500/20 text-purple-700",
    partially_refunded: "bg-purple-400/20 text-purple-600",
    on_hold: "bg-gray-500/20 text-gray-700",
  };
          ...
          <Card>
            ...
            <CardContent>
              <div className={cn(
                ...
                order.fraudAnalysis.riskLevel === "low" && "bg-green-100 text-green-700",
                order.fraudAnalysis.riskLevel === "medium" && "bg-yellow-100 text-yellow-700",
                order.fraudAnalysis.riskLevel === "high" && "bg-orange-100 text-orange-700",
                order.fraudAnalysis.riskLevel === "critical" && "bg-red-100 text-red-700",
              )}>
