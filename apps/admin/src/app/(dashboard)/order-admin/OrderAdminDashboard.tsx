...
export default function OrderAdminDashboard({ stats, revenueByDay, statusDistribution }: DashboardProps) {
  const statCards = [
    { title: "Total Orders", value: stats.totalOrders || 0, description: "All time" },
    { title: "Total Revenue", value: formatCurrency(stats.totalRevenue || 0), description: "All time" },
    { title: "Today's Orders", value: stats.todayOrders || 0, description: "Since midnight" },
    { title: "Today's Revenue", value: formatCurrency(stats.todayRevenue || 0), description: "Since midnight" },
    { title: "Avg Order Value", value: formatCurrency(stats.avgOrderValue || 0), description: "Per order" },
    { title: "Pending", value: stats.pendingOrders || 0, description: "Awaiting action", color: "text-yellow-600" },
    { title: "Completed", value: stats.completedOrders || 0, description: "Delivered/Paid", color: "text-green-600" },
    { title: "Refunded", value: stats.refundedOrders || 0, description: "Returns processed", color: "text-red-600" },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Link href="/order-admin/orders?status=pending">
          <Card className="hover:border-primary transition-colors cursor-pointer">
            <CardHeader>
